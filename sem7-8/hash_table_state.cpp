...
void print_hash_table_state(const std::unordered_set < int > & unordered_set)
{
	...
	std::cout << "load factor:     " << unordered_set.load_factor() << std::endl; //  average number of elements per bucket
	std::cout << "max load factor: " << unordered_set.max_load_factor() << std::endl; // maximum number of elements per bucket
